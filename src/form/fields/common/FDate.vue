<template>
  <div class="field-box" >
    ...
    <DatePicker v-else class="field-box-right" :placeholder="data.placeholder" :disabled="disabled"
       v-model="data.value" type="datetime" format="yyyy-MM-dd HH:mm:ss"></DatePicker>
  </div>
</template>
