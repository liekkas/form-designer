<template>
  <div class="field-box" >
    ...
    <Input v-else class="field-box-right" :class="{ 'ivu-form-item-error .ivu-input' : isInvalide }"
      @on-blur="validate"
      v-model="data.value" :placeholder="data.placeholder" :disabled="disabled"></Input>
  </div>
</template>
